...
export default function ImageUpload(props) {
  ...
  React.useEffect(() => {
    if (typeof props.stampImg.level4 != "undefined") {
      if (typeof props.stampImg.level4.eStamp != "undefined") {
        var preImage = props.stampImg.level4.eStamp;
        var base64Flag = `data:${props.stampImg.level4.eStampT};base64,`;
  ...
  const handleSubmit = () => {
    ...
    bodyFormData.append("loginName", props.stampImg.level3.loginName);
    let msg = "";
    
    axios({
      method: "post",
      url: `${process.env.REACT_APP_LDOCS_API_URL}/dev/upd/avuserfourstamp`,
      data: bodyFormData,
