          ...
          <Card>
            ...
            <CardBody>
              ...
              <Table
                ...
                tableData={typeof fileHistory.recentInvoices !== "undefined" && fileHistory.recentInvoices.length > 0 ? fileHistory.recentInvoices.map((file,index)=>{return [file.invoiceId,file.version,formatDateTime(file.invoiceDate), formatDateTime(file.dueDate) ,file.vendorName,`${file.FC_currency ? file.FC_currency.Symbol : '$'} ${addZeroes(file.netAmt)} / ${file.LC_currency ? file.LC_currency.Symbol : ""} ${addZeroes(file.netAmt_bc ? file.netAmt_bc : 0.00) 
                }` ]}): []}
              />
              }
            </CardBody>
