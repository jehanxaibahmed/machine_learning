        ...
        <GridContainer>
            ...
            <GridContainer>
                ...
                <Table
                    ...
                    tableData={fileData.map((file,index)=>{return [file.invoiceId, formatDateTime(file.invoiceDate), formatDateTime(file.dueDate) ,file.vendorName,`${file.FC_currency.Symbol}${addZeroes(file.netAmt)}`,file.version,(<Button
                        round
